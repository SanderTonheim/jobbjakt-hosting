            ...
            >
                <div className='mb-6 '>
                    <ul className='mx-auto text-2xl w-60 text-whit center'>
                        ...
                        <li
                            className={`h-20 flex justify-start pl-3 items-center text-left cursor-pointer ${
                                whatIfContent
                                    ? "bg-[#394F3B] text-white"
                                    : " bg-transparent"
                            }`}
                        ...
                        <li
                            className={`h-20 flex justify-start pl-3 items-center self-start cursor-pointer ${
                                fiveClassicsContent
                                    ? "bg-[#394F3B] text-white"
                                    : " bg-transparent"
                            }`}
                ...
                <div>
                    ...
                    >
                        <div className='pb-8 ml-6 '>
                            <h2 className='mt-4 text-[22px]'>5 Klassikere</h2>
                            <p className='my-4'>
