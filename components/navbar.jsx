      ...
      <div className="justify-between px-4 mx-auto lg:items-center lg:flex lg:px-8">
        ...
        <div className="">
          <div
            className={`${
              navbar
                ? "bg-black absolute left-0 right-0 top-[65px] z-30 py-4"
                : "hidden lg:block"
            }`}
          >
            {/* Nav LInks  */}
            ...
            >
              <li
                ...
                } text-white hover:text-jj-nav-link-hover`}
              >
              ...
              <li
                ...
                } text-white hover:text-jj-nav-link-hover lg:hidden`}
              >
                  ...
                  <ul class="absolute hidden text-white text-center pt-1 group-hover:block">
                    <li>
                      <Link
                        ...
                        className={`${
                          router.pathname === "/sok-jobb/cv" ? "underline" : ""
                        } rounded-t bg-green-700 hover:bg-gray-400 py-2 px-10 block whitespace-no-wrap `}
                        href="/sok-jobb/cv"
                      >
                        CV
                      </Link>
                    ...
                    <li class="">
                      <Link
                        ...
                        className={`${
                          router.pathname === "/sok-jobb/soknad"
                            ? "underline"
                            : ""
                        } rounded-b bg-green-700 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap`}
                      >
                        Søknad
                      </Link>
                    </li>
