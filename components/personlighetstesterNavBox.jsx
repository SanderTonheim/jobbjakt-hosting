			...
			<div className={`flex ${personality ? 'content' : 'hidden'}`}>
				<div>
					<ul className='sticky left-0 my-auto text-2xl border-2 border-solid border-jj-color-green top-10 w-60 center'>
						...
						<li
							className={`h-20 flex justify-start pl-5 items-center text-center cursor-pointer ${whatIfContent ? 'bg-[#394F3B] text-white' : ' bg-transparent'}`}
							onClick={() => {
								DeactivateState()
						...
						<li
							className={`h-20 flex justify-start pl-5 items-center text-center cursor-pointer ${toAskContent ? 'bg-[#394F3B] text-white' : ' bg-transparent'}`}
							onClick={() => {
								DeactivateState()
				...
				<div>
					<section className={`w-full ${preperationContent ? 'content' : 'hidden'}`}>
						<div className='pb-8 ml-6 '>
							...
							<h3 className='mt-4 mb-2 '>«Inside»-tips i forbindelse med personlighetstester.</h3>
							<p>
					...
					<section className={`w-full ${whatIfContent ? 'content' : 'hidden'}`}>
						<div className='pb-8 ml-8 '>
							...
							<h3 className='mt-4 mb-2 '>Analyse/vurdering og bruk av testen.</h3>
							<p>
							...
							<h3 className='mt-4 mb-2 font-bold'>Diskutere testresultatet med kandidaten.</h3>
							<p>Kandidaten involveres aktivt i tolkning og nyansering av resultatet.</p>
							...
							<h3 className='mt-4 mb-2 font-bold'>Oppsummere styrker og utviklingsområder.</h3>
							<ul>
					...
					<section className={`w-full ${fiveClassicsContent ? 'content' : 'hidden'}`}>
						<div className='pb-8 ml-6 '>
							...
							<h3 className='mt-4 mb-2 font-bold'>Personligheten kan gi deg jobb.</h3>
							<p>Jobbintervjuet er ikke lenger det eneste nåløyet du må passere hvis du vil bytte jobb. Nå er det personlighetstester som gjelder, også i helt vanlige jobber.</p>
							...
							<h3 className='mt-4 mb-2 font-bold'>I tida - antall firma som leverer personlighetstester har økt kraftig.</h3>
							<p>
								...
								trenden. – Slike tester er veldig i tida. Man finner spor av personligheten til folk overalt, og det har de som ansetter etter hvert begynt å skjønne. Kunnskap er ikke nok for å kunne
								mestre en jobb.
							</p>
							<h3 className='mt-4 mb-2 font-bold'>Testene kan lures.</h3>
							<p> Hittil er personlighetstester brukt mest i jobber der sosiale evner er viktige, som for eksempel ledere, selgere og konsulenter.</p>

							<p className='my-4'>
								Selv om de fleste testene har mange spørsmål som stilles på mange forskjellige måter, går det an å lure dem.{' '}
								<span className='italic font-medium'>– Vet du hvilke egenskaper firmaet du søker jobb hos vil ha, kan du greie å lure testen, sier Hilmar Nordvik.</span> Likevel mener han at de aller
								beste testene på markedet er mer eller mindre vanntette.
							</p>
							<h3 className='mt-4 mb-2 font-bold'>Kvalitetsopprensking</h3>
							<p>
								{' '}
							...
							<p className='mt-4'>I mengden av personlighetstester er det ikke alle som holder mål.</p>
							<p className='my-4 '>
							...
							<h3 className='mt-4 mb-2 font-bold'>Eksempel på personlighetstest</h3>
							<ol>
								<ul>– Jeg foretrekker å bruke den tida som er nødvendig for å gjøre en oppgave grundig. (Pliktoppfyllende og systematisk).</ul>
								<ul>– Jeg liker å treffe nye mennesker. (Utadvendt).</ul>
								<ul>– Jeg kommer vanligvis tidsnok til avtaler. (Pliktoppfyllende og systematisk).</ul>
								<ul>– Jeg pleier å være aktiv og ta ordet når flere er samlet. (Utadvendt).</ul>
								<ul>– Jeg er flink til å overholde tidsfrister. (Pliktoppfyllende og systematisk).</ul>
								<ul>– Jeg foretrekker å gå ut med venner framfor å ha en rolig kveld hjemme. (Utadvendt).</ul>
							</ol>
							<h3 className='mt-4 mb-2 font-bold'>Kontrollspørsmål</h3>
							<p> For å sjekke om kandidaten har en tendens til å framstille seg selv positivt benyttes kontrollspørsmål, som disse:</p>
							<ol className='my-4'>
					...
					<section className={`w-full ${toAskContent ? 'content' : 'hidden'}`}>
						<div className='pb-8 ml-6 '>
							<h2 className='my-4'>Dette ser de etter i 16 PF.</h2>
							...
							<p className='my-4'>
								...
								<br /> Eks.:{' '}
								<span className='italic '>Vil du jobbe i reklamebransjen, kan det lønne seg å være abstrakt i resonneringen, vil du bli forsker kan det lønne seg å være konkret i resonneringen.</span>
							</p>
							<Image src={schema}></Image>
							<h2 className='mt-8'>Hva er 16 Personality Questionnaire – 5. versjon.</h2>
							...
							<p className='my-4 font-medium'>De 16 primære skalaene kan kombineres til 5 globale skalaer som gir en mer allmenn og bredere bilde av personligheten uttrykt gjennom begrepene:</p>
							<ul className='my-4'>
								<li>– Ekstraversjon (ekstravert – introvert)</li>
								<li>– Angst (lav angst – høy angst)</li>
								<li>– Tøffhet (mottakelig – tøff)</li>
								<li>– Uavhengighet (medgjørlig – egenrådig)</li>
								<li>– Selvkontroll (ukontrollert – høy selvkontroll)</li>
							</ul>
							<h3 className='mt-4 mb-2 font-bold'>Komme i gang </h3>
							<p> For å benytte 16PF må du være sertifisert i verktøyet og lisensiert hos Assessio. Se våre kursdatoer for 16PF under utdanning på våre hjemmesider.</p>
							...
							<h2 className='mt-4'>Hva er Hogans personlighetsinventorium – HPI.</h2>
							<p className='my-4 text-sm italic'>
							...
							<h3 className='mt-4 '>HPI inneholder 7 primære personlighetsskalaer:</h3>
							<ul className='my-2'>
								<li>– Tilpasning (grad av emosjonalitet, stressmestring, selvkritikk)</li>
								<li>– Ambisjon (måler holdning til yrkesmessige mål og innstilling til karriere)</li>
								<li>– Selskapelighet (i hvilken utstrekning en person har behov for/ setter pris på sosial interaksjon)</li>
								<li>– Sympatiskhet (måler taktfølelse, vennskapelighet, lydhørhet)</li>
								<li>– Ordentlighet (grad av selvkontroll/impulsivitet, nøyaktighet)</li>
								<li>– Intellektualitet (skalaen berører livsstilsspørsmål, originalitet, innstilling til rutinearbeid)</li>
								<li>– Studieinteresse (speiler i hvilken utstrekning en person trives med ”akademiske” aktiviteter og kunnskap)</li>
							</ul>
							...
							<ul className='my-4'>
								<li>– Serviceinnstilling (identifiserer personer som er vennlige, morsomme, hjelpsomme)</li>
								<li>– Stresstoleranse (identifiserer personer som kan håndtere stress godt)</li>
								<li>– Integritet (identifiserer ærlige, pålitelige personer)</li>
								<li>– Administrativt potensial (identifiserer nøyaktige og produktive personer med blikk for detaljer)</li>
								<li>– Selgerpotensial (identifiserer sosialt kompetente og trygge personer som evner å skape interesse for et produkt eller en tjeneste)</li>
								<li>– Lederpotensial (identifiserer personer som på en positiv og effektiv måte kan lede andres arbeid)</li>
							</ul>
							...
							<p>
								...
								<br />I den norske manualen beskrives bakgrunnen for testen, utprøvningsarbeidet, samt retningslinjer for tolkning. Samtlige skalaer beskrives i detalj og hensiktsmessige hypoteser og
							...
							<h2 className='my-4'>Hva er Myers-BriggsType Indicator®-MBTI®</h2>
							<p className='my-4 text-sm italic'>
								Testen er laget av Isabel Myers & Katherine C. Briggs.
								<br />
								Kilde: Assessio
							</p>
							<h3 className='mt-4 mb-2'>Hensikt: Personlighetsindikator</h3>
							<p>Norsk/svensk. MBTI er også tilgjengelig på britisk, dansk, hollandsk, spansk, italiensk, tysk og fransk.</p>
							<p className='mt-4'>
							...
							<p className='mt-4 font-medium'>Grunntanken bak MBTI® er at et hvert individ har basale, foretrukne måter å forholde seg på (eller ulike preferanser) når det gjelder:</p>
							<ul className='mt-4'>
							...
							<p>
								{' '}
								For å benytte MBTI må du være sertifisert og lisensiert hos Assessio. <br /> Se våre kursdatoer for MBTI. Kursdeltakere mottar en introduksjonspakke. Den består av en amerikansk
								manual, 2 spørrehefter (Step 1), 1 pk selvskåringsark, 2 hefter Introduksjon til type og 2 hefte.
							</p>
