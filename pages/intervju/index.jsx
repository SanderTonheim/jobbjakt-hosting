	...
	return (
		<>
			<main className='mx-3 xxs:mx-10 xs:mx-20 md:w-[688px] md:mx-auto lg:w-[796px] xl:w-[1088px] md:text-lg'>
				...
				/>
				{/* </div> */}
				<h1 className='mx-3 my-8 text-2xl xxs:mx-1 xs:mx-0 md:text-left md:text-3xl xl:text-4xl lg:pt-16'>Intervju</h1>
				...
				<section className=''>
					...
					<div className='DESKTOP-CARDS hidden cursor-pointer   md:p-5 md:visible text-white border-b-2 border-b-[#394F3B]  md:flex md:w-full md:justify-evenly md:text-center md:mx-auto md:my-5 place-content-center lg:max-w-[1120px] center '>
						<h2
							className={`text-2x hover:text-jj-nav-link-hover ${prepare ? 'underline' : ' no-underline'}`}
							onClick={() => {
								DeactivateState()
								setPrepare(true)
							}}>
						...
						<h2
							className={`text-2x hover:text-jj-nav-link-hover ${personality ? 'underline' : ' no-underline'}`}
							onClick={() => {
								DeactivateState()
								setPersonality(true)
							}}>
						...
						<h2
							className={`text-2x hover:text-jj-nav-link-hover ${reference ? 'underline' : ' no-underline'}`}
							onClick={() => {
								DeactivateState()
								setReference(true)
							}}>
